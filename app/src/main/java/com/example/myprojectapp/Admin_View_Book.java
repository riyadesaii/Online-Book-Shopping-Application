...
public class Admin_View_Book extends Fragment {
    ListView lv1;
    SQLiteDatabase db;
    Cursor c;
    @Nullable
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.admin_view_book,container,false);
        try {
    ...
    private void loadbookdetail() {
        ...
        Admin_View_Book_clv ob=new Admin_View_Book_clv(getActivity(),c,0);
        lv1.setAdapter(ob);
    }
}
